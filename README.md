# HIVE (Hive handles Integration, Validation, & Execution)
...
You can download portable executables from the [Releases tab](https://github.com/ak47andrew/hive/releases)
...
```shell
git clone https://github.com/ak47andrew/hive.git
```
...
Info about BEE programming language and NJ target can be found in [GitHub wiki](https://github.com/ak47andrew/hive/wiki)

## Known Issues

Check [Changelog](CHANGELOG.md) and [GitHub issues](https://github.com/ak47andrew/hive/issues)
...
Feels free to suggest your [pull requests](https://github.com/ak47andrew/hive/pulls) with any bug fixes and ideas

If you encounter any errors, please report them [on GitHub](https://github.com/ak47andrew/hive/issues)

[Discussions](https://github.com/ak47andrew/hive/discussions) available for ideas, brainstorming (pun intended), use-cases
